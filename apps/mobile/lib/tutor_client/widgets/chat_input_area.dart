                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.pendingFileName != null)
                      _AttachmentPreviewWidget(
                        pendingFileName: widget.pendingFileName!,
                        pendingPreviewData: widget.pendingPreviewData,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: widget.isRecording
                              ...
                              : TextField(
                                  ...
                                  onSubmitted: (_) {
                                    if (_hasTextContent && !widget.isGenerating) {
                        ...
                        Padding(
                          ...
                          child: _DynamicRightActions(
                            hasContent: _hasTextContent || widget.pendingFileUrl != null,
      ...
      children: [
        ...
        Semantics(
          ...
          child: Container(
            ...
            child: IconButton(
              icon: const Icon(CupertinoIcons.waveform, size: 20),
              color: theme.colorScheme.onPrimary,
...
class _AttachmentPreviewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isImage = ['png', 'jpg', 'jpeg', 'gif', 'webp']
        .any((ext) => pendingFileName.toLowerCase().endsWith(ext));

    return Semantics(
      label: 'Selected attachment: $pendingFileName',
      child: Container(
              ...
              children: [
                ClipRRect(
                  ...
                  child: SizedBox(
                    width: 44,
                    height: 44,
                    child: isImage && pendingPreviewData != null
                        ? _AttachmentThumbnail(dataUri: pendingPreviewData!)
                        : Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        semanticsLabel: 'File name: $pendingFileName',
                      ),
            ...
            Positioned(
              ...
              child: Semantics(
                ...
                child: GestureDetector(
                  onTap: isUploading ? null : onClearPendingAttachment,
                  child: Container(
