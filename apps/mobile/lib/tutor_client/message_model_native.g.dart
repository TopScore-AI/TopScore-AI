...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[1], object.desmosDataJson);
  writer.writeLong(offsets[2], object.feedback);
  writer.writeString(offsets[3], object.flashcardDataJson);
  writer.writeString(offsets[4], object.graphDataJson);
  writer.writeString(offsets[5], object.id);
  writer.writeString(offsets[6], object.imageUrl);
  writer.writeBool(offsets[7], object.isBookmarked);
  writer.writeBool(offsets[8], object.isComplete);
  writer.writeBool(offsets[9], object.isKicdCertified);
  writer.writeBool(offsets[10], object.isTemporary);
  writer.writeBool(offsets[11], object.isThinking);
  writer.writeBool(offsets[12], object.isThought);
  writer.writeBool(offsets[13], object.isUser);
  writer.writeString(offsets[14], object.mathAnswer);
  writer.writeStringList(offsets[15], object.mathSteps);
  writer.writeString(offsets[16], object.mnemonicDataJson);
  writer.writeString(offsets[17], object.quizDataJson);
  writer.writeString(offsets[18], object.reasoning);
  writer.writeString(offsets[19], object.replyToId);
  writer.writeString(offsets[20], object.replyToText);
  ...
  writer.writeString(offsets[24], object.threadId);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    desmosDataJson: reader.readStringOrNull(offsets[1]),
    feedback: reader.readLongOrNull(offsets[2]),
    flashcardDataJson: reader.readStringOrNull(offsets[3]),
    graphDataJson: reader.readStringOrNull(offsets[4]),
    id: reader.readString(offsets[5]),
    imageUrl: reader.readStringOrNull(offsets[6]),
    isBookmarked: reader.readBoolOrNull(offsets[7]) ?? false,
    isComplete: reader.readBoolOrNull(offsets[8]) ?? true,
    isKicdCertified: reader.readBoolOrNull(offsets[9]) ?? false,
    isTemporary: reader.readBoolOrNull(offsets[10]) ?? false,
    isThinking: reader.readBoolOrNull(offsets[11]) ?? false,
    isThought: reader.readBoolOrNull(offsets[12]) ?? false,
    isUser: reader.readBool(offsets[13]),
    mathAnswer: reader.readStringOrNull(offsets[14]),
    mathSteps: reader.readStringList(offsets[15]),
    mnemonicDataJson: reader.readStringOrNull(offsets[16]),
    quizDataJson: reader.readStringOrNull(offsets[17]),
    reasoning: reader.readStringOrNull(offsets[18]),
    replyToId: reader.readStringOrNull(offsets[19]),
    replyToText: reader.readStringOrNull(offsets[20]),
    ...
    status:
        _ChatMessagestatusValueEnumMap[reader.readByteOrNull(offsets[22])] ??
            MessageStatus.sent,
    text: reader.readString(offsets[23]),
    threadId: reader.readStringOrNull(offsets[24]),
    timestamp: reader.readDateTime(offsets[25]),
