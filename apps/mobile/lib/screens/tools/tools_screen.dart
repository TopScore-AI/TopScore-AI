...
const _allTools = [
  ...
  _Tool(id: 'quiz', title: 'AI Quiz', description: 'Test your knowledge with AI', icon: Icons.quiz_rounded, color: Color(0xFF00BCD4), category: 'Study'),
  ...
  _Tool(id: 'summarizer', title: 'PDF Summarizer', description: 'AI extracts notes from your PDFs', icon: Icons.summarize_rounded, color: Color(0xFFF59E0B), category: 'Study'),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.06) : tool.color.withValues(alpha: 0.12)),
