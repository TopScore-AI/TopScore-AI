const en = {
    ...
    'features.0.tags': 'Maths,Science,English,CBC,KCSE',

    'features.1.title': 'Full Resource Library',
    'features.1.desc': 'Thousands of past papers, revision notes, topical exercises, and mock exams — organised by curriculum (CBC & 8-4-4), grade, and subject. Download for offline use.',
    'features.1.tags': 'Past Papers,Notes,Flashcards,Offline',
    ...
    'tools.0.name': 'Smart Scanner',
    'tools.0.desc': 'Scan & solve',
    'tools.1.name': 'Calculator',
    'tools.1.desc': 'Scientific calc',
    'tools.2.name': 'Science Lab',
    'tools.2.desc': 'Virtual experiments',
    'tools.3.name': 'Periodic Table',
    'tools.3.desc': 'Interactive elements',
    'tools.4.name': 'Flashcard Generator',
    'tools.4.desc': 'AI-generated cards',
    'tools.5.name': 'Timetable',
    'tools.5.desc': 'Schedule & reminders',
    'tools.6.name': 'Global Search',
    'tools.6.desc': 'Find anything instantly',
    'tools.7.name': 'PDF Viewer',
    'tools.7.desc': 'Read & annotate docs',
