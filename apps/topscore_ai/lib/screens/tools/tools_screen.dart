...
const _allTools = [
  _Tool(
      id: 'flashcards',
      title: 'AI Flashcards',
      description: 'Generate study cards from any topic',
  ...
  _Tool(
      id: 'scanner',
      title: 'Doc Scanner',
      description: 'Digitize notes & solve problems',
  ...
  _Tool(
      ...
      description: 'AI extracts notes from your PDFs',
...
class _ToolsScreenState extends State<ToolsScreen> {
  ...
  List<_Tool> get _recents => _recentIds
      .map((id) => _allTools.firstWhere((t) => t.id == id,
            ...
            .map((tool) => GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: tool.color.withValues(alpha: 0.2)),
                    ),
                    child: Column(
