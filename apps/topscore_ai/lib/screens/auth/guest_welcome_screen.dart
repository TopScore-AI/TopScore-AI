          ...
          child: Column(
            children: [
              ...
              if (!limitReached)
                ...
                Text(
                  limitReached
                      ? 'You\'ve used your 5 free AI solves. Create\na profile to continue learning.'
                      : 'Snap a photo of your topic or ask any\nquestion. Your first 5 messages are free!',
                  textAlign: TextAlign.center,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Create a free profile to save your solutions and build your personal study library. TopScore AI is even better with an account!',
              textAlign: TextAlign.center,
              style: GoogleFonts.dmSans(
                fontSize: 15,
                color: theme.hintColor,
