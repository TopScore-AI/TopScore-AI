...
class UserModel {
  ...
  final String? preferredName; // What the AI tutor calls the student
  ...
  /// Serializes only foundational identity fields for new profile initialization.
  /// Prevents accidental overwrites of existing subscription or usage data.
  Map<String, dynamic> toInitialProfileMap() {
    return {
      'uid': uid,
      'email': email,
